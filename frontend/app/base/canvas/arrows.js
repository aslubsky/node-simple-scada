define([
    ...
    function Arrows() {
        ...
        this.draws.push(function() {
            this.ctx.save();
            this.ctx.fillStyle = this.color;
            this.ctx.translate(200,129);
            this.ctx.rotate(1.5707963267948966);
            this.ctx.translate(-200,-129);
            this.ctx.beginPath();
            this.ctx.moveTo(217,154);
            this.ctx.lineTo(217,129);
            this.ctx.bezierCurveTo(217,127,215,126,213,126);
            this.ctx.lineTo(190,126);
            this.ctx.lineTo(190,133);
            this.ctx.lineTo(155,118);
            this.ctx.lineTo(190,104);
            this.ctx.lineTo(190,111);
            this.ctx.lineTo(213,111);
            this.ctx.bezierCurveTo(230,111,244,119,244,129);
            this.ctx.lineTo(244,154);
            this.ctx.closePath();
            this.ctx.fill();
            this.ctx.restore();
        });
        ...
        this.draws.push(function() {
            this.ctx.fillStyle = this.color;
            this.ctx.beginPath();
            this.ctx.moveTo(413,40);
            this.ctx.lineTo(451,40);
