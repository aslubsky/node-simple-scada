...
//        this.$scope = null;
    ...
    this.draws.push(function () {
        this.ctx.beginPath();
        this.ctx.moveTo(58, 1);
        this.ctx.bezierCurveTo(70.28833568373516, 1, 80.25, 10.711664316264843, 80.25, 23);
        ...
        this.ctx.bezierCurveTo(35.75, 10.711664316264843, 45.711664316264844, 1, 58, 1);
        this.ctx.closePath();
    });

    this.draws.push(function () {
        this.ctx.beginPath();
        this.ctx.moveTo(58, 5);
        this.ctx.bezierCurveTo(68.07919668441198, 5, 76.25, 12.920803315588017, 76.25, 23);
        ...
        this.ctx.bezierCurveTo(39.75, 12.920803315588017, 47.92080331558802, 5, 58, 5);
        this.ctx.closePath();
    });
...
WaterCounter.prototype = new Figure();